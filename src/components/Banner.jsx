const Banner = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(to right, rgba(0,0,0,0.6), rgba(0,0,0,0)), url(http://localhost:3000/assets/at_the_piano-927c6b07024ae358bb711c8f859fccff7657aefd1790a0db7530364d65168056.jpg)",
      }}
    >
